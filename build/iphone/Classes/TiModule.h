...
/**
 The base class for all RelayMgr modules
 */
...
/**
 RelayMgr Platform calls this method on startup.
 */
-(void)startup;

/**
 RelayMgr Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 RelayMgr Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 RelayMgr Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 RelayMgr Platform calls this method on resume.
 @param sender The sender of the event.
 */

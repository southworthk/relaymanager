 ...
 * Copyright (c) 2009-2011 by RelayMgr, Inc. All Rights Reserved.
...
//@interface RelayMgrObject : NSObject
//@end

@interface RelayMgrObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[RelayMgrObject class]])
		{
			for (NSString *key in [[(RelayMgrObject*)o modules] allKeys])
			{

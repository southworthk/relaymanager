...
// in simulator we redefine to format for RelayMgr Developer console
...
{\
	NSString * exceptionName = [@"org.relaymgr." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.relaymgr";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIRelayMgrNativeItemNone = -1, 
	UIRelayMgrNativeItemSpinner = -2,
	UIRelayMgrNativeItemProgressBar = -3,
	
	UIRelayMgrNativeItemSlider = -4,
	UIRelayMgrNativeItemSwitch = -5,
	UIRelayMgrNativeItemMultiButton = -6,
	UIRelayMgrNativeItemSegmented = -7,
	
	UIRelayMgrNativeItemTextView = -8,
	UIRelayMgrNativeItemTextField = -9,
	UIRelayMgrNativeItemSearchBar = -10,
	
	UIRelayMgrNativeItemPicker = -11,
	UIRelayMgrNativeItemDatePicker = -12,
	
	UIRelayMgrNativeItemInfoLight = -13,
	UIRelayMgrNativeItemInfoDark = -14,
	
	UIRelayMgrNativeItemDisclosure = -15,
	
	UIRelayMgrNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all RelayMgr instances of
